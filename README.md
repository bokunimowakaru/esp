...
### 2-1 (IoTセンサ) Wi-Fi 照度計 (CSVxUDP方式)
...
### 2-2 (IoTセンサ) Wi-Fi 温度計 (CSVxUDP方式)
...
### 2-3 (IoTセンサ) Wi-Fi ドア開閉モニタ (CSVxUDP方式)
...
### 2-4 (IoTセンサ) Wi-Fi 温湿度計 (CSVxUDP方式)
...
### 2-5 (IoTセンサ) Wi-Fi 気圧計 (CSVxUDP方式)
...
### 2-7 (IoTセンサ) Wi-Fi 3軸加速度センサ (CSVxUDP方式)
...
### 2-9 (IoTセンサ) Wi-Fi リモコン赤外線レシーバ (CSVxUDP方式)
