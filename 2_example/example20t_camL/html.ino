...
void html(WiFiClient &client, int size, int update, uint32_t ip){
    ...
    client.println(F("画質:<input type=\"submit\" name=\"RATIO\" value=\"255 高圧縮\">"));
    client.println(F("<input type=\"submit\" name=\"RATIO\" value=\"155 中圧縮\">"));
    client.println(F("<input type=\"submit\" name=\"RATIO\" value=\"56 標準\"><br><br>"));
