/*******************************************************************************
Example 4c: ケチケチ運転術 クラウドサービスAmbientへの送信機能つき
乾電池などで動作するIoTセンサ用のクラウドサービスAmbientへの送信機能つき版です。
...
void loop(){
    ...
    /* Ambientへ送信 */
    dtostrf(((float)adc)/1024.,-15,3,s);    // 電圧値を文字列に変換
    ambient.set(1,s);                       // Ambient(データ1)へ送信
    dtostrf(t,-15,3,s);                     // 時間を文字列に変換
