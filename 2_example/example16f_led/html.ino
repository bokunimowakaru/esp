...
void html(WiFiClient &client, int target, uint32_t ip){
    ...
    sprintf(s,"<form method=\"GET\" action=\"http://%s/\">",s_ip);
    client.println(s);
    client.println("<input type=\"submit\" name=\"R\" value=\"0 (LED OFF)\">");
    client.println("<input type=\"submit\" name=\"R\" value=\"-2 (輝度20%)\">");
    client.println("<input type=\"submit\" name=\"R\" value=\"-4 (輝度40%)\">");
    client.println("<input type=\"submit\" name=\"R\" value=\"-6 (輝度60%)\">");
    client.println("<input type=\"submit\" name=\"R\" value=\"-8 (輝度80%)\">");
    client.println("<input type=\"submit\" name=\"R\" value=\"1 (LED ON)\">");
    client.println("</form>");
    client.print("<p>http://");
    client.print(s_ip);
    ...
    sprintf(s,"<form method=\"GET\" action=\"http://%s/\">",s_ip);
    client.println(s);
    client.println("<input type=\"submit\" name=\"G\" value=\"0 (LED OFF)\">");
    client.println("<input type=\"submit\" name=\"G\" value=\"-2 (輝度20%)\">");
    client.println("<input type=\"submit\" name=\"G\" value=\"-4 (輝度40%)\">");
    client.println("<input type=\"submit\" name=\"G\" value=\"-6 (輝度60%)\">");
    client.println("<input type=\"submit\" name=\"G\" value=\"-8 (輝度80%)\">");
    client.println("<input type=\"submit\" name=\"G\" value=\"1 (LED ON)\">");
    client.println("</form>");
    client.println(s);
    client.println("<input type=\"text\" name=\"G\" value=\"\">");
    client.println("<input type=\"submit\" value=\"送信\">");
    client.println("</form>");
    client.print("<p>http://");
    client.print(s_ip);
    ...
    sprintf(s,"<form method=\"GET\" action=\"http://%s/\">",s_ip);
    client.println(s);
    client.println("<input type=\"submit\" name=\"B\" value=\"0 (LED OFF)\">");
    client.println("<input type=\"submit\" name=\"B\" value=\"-2 (輝度20%)\">");
    client.println("<input type=\"submit\" name=\"B\" value=\"-4 (輝度40%)\">");
    client.println("<input type=\"submit\" name=\"B\" value=\"-6 (輝度60%)\">");
    client.println("<input type=\"submit\" name=\"B\" value=\"-8 (輝度80%)\">");
    client.println("<input type=\"submit\" name=\"B\" value=\"1 (LED ON)\">");
    client.println("</form>");
    client.println(s);
