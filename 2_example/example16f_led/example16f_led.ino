/*******************************************************************************
Example 16f: Wi-Fi コンシェルジェ 照明担当 (フルカラーLED制御)
HTTPによるWebサーバ機能搭載 Wi-FiコンシェルジェがフルカラーLEDを制御します。
...
#define PIN_LED_R 13                        // IO 13(5番ピン)にLEDを接続する
#define PIN_LED_G 12                        // IO 12(4番ピン)にLEDを接続する
#define PIN_LED_B 14                        // IO 14(3番ピン)にLEDを接続する
