/*******************************************************************************
Example 59: 乾電池駆動可能なCO2センサ SDP30 ＋温度・湿度 SHT31

[動作未確認]

CO2センサ SENSIRION SDP30
湿度センサ SENSIRION SHT31

※ご注意 ESP8266版(AMS CCS811 + BME280)とは使用するセンサが異なります。
※湿度によるCO2センサの補正は行っていません。
...
#define DEVICE "e_co2_3,"                   // デバイス名(5文字+"_"+番号+",")
