/*******************************************************************************
Example 25a: Wi-Fi コンシェルジェ 情報担当（ファイル共有サーバ・FTPサーバ）
各種 Wi－Fi 対応IoT センサ機器から送られてきたセンサ値データを保持します。
...
ファイルサイズは100kB以下を推奨します。
ファイル転送中は他の処理が出来なくなります。
ファイル転送中にハングアップする場合があります。
